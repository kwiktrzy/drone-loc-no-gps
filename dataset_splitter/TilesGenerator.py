...
# # tiles_satelite_map_output_directory ='/kaggle/working/map_tiles'
# # # tiles_satelite_csv_output_path ='/kaggle/working/satelite_tiles_coords.csv'
...
class TilesGenerator:
    ...
    def __get_gps_coords(
        ...
        return (
            top_left_crop_lat,
            top_left_crop_lon,
            bottom_right_crop_lat,
            bottom_right_crop_lon,
        )
        ...
        with rasterio.open(map.map_tif_path) as src:
            ...
            for i, (patch, coords) in enumerate(
                ...
                row = {
                    ...
                    "lon": lon,
                    "lat": lat,
                    "patch_width": coords[4],
                    "patch_height": coords[5],
                ...
                if self.patch_format_compress[0] == ".png":
                    ...
                    print("OH NO...u used unsupported tile format!")
                    return
